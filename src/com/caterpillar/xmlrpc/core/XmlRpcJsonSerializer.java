...
public class XmlRpcJsonSerializer extends XmlRpcSerializer
{
    ...
    public XmlRpcJsonSerializer( boolean addCustomSerializers )
    {
        ...
        {
            customSerializers.add( new com.caterpillar.xmlrpc.serializers.json.MapSerializer() );
            customSerializers.add( new com.caterpillar.xmlrpc.serializers.json.ListSerializer() );
            customSerializers.add( new com.caterpillar.xmlrpc.serializers.json.CollectionSerializer() );
            customSerializers.add( new com.caterpillar.xmlrpc.serializers.json.ObjectArraySerializer() );
            customSerializers.add( new com.caterpillar.xmlrpc.serializers.json.IntArraySerializer() );
            customSerializers.add( new com.caterpillar.xmlrpc.serializers.json.FloatArraySerializer() );
            customSerializers.add( new com.caterpillar.xmlrpc.serializers.json.DoubleArraySerializer() );
            customSerializers.add( new com.caterpillar.xmlrpc.serializers.json.BooleanArraySerializer() );
