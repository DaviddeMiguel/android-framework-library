...
import com.caterpillar.xmlrpc.util.Base64;
...
public class XmlRpcSerializer
{
    ...
    public XmlRpcSerializer( boolean addCustomSerializers )
    {
        ...
        {
            customSerializers.add( new com.caterpillar.xmlrpc.serializers.LongPrimitiveSerializer() );
            customSerializers.add( new com.caterpillar.xmlrpc.serializers.LongWrapperSerializer() );
            customSerializers.add( new com.caterpillar.xmlrpc.serializers.MapSerializer() );
            customSerializers.add( new com.caterpillar.xmlrpc.serializers.ListSerializer() );
            customSerializers.add( new com.caterpillar.xmlrpc.serializers.CollectionSerializer() );
            customSerializers.add( new com.caterpillar.xmlrpc.serializers.ObjectArraySerializer() );
            customSerializers.add( new com.caterpillar.xmlrpc.serializers.IntArraySerializer() );
            customSerializers.add( new com.caterpillar.xmlrpc.serializers.FloatArraySerializer() );
            customSerializers.add( new com.caterpillar.xmlrpc.serializers.LongArraySerializer() );
            customSerializers.add( new com.caterpillar.xmlrpc.serializers.DoubleArraySerializer() );
            customSerializers.add( new com.caterpillar.xmlrpc.serializers.BooleanArraySerializer() );
